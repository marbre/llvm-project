// RUN: mlir-translate -mlir-to-c %s | FileCheck %s -check-prefix=C-DEFAULT
// RUN: mlir-translate -mlir-to-cpp %s | FileCheck %s -check-prefix=CPP-DEFAULT
// RUN: mlir-translate -mlir-to-c-forward-declared %s | FileCheck %s -check-prefix=C-FWDDECL
// RUN: mlir-translate -mlir-to-cpp-forward-declared %s | FileCheck %s -check-prefix=CPP-FWDDECL
