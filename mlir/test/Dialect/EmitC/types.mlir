// RUN: mlir-opt -allow-unregistered-dialect -verify-diagnostics %s | FileCheck %s
// check parser
// RUN: mlir-opt -allow-unregistered-dialect -verify-diagnostics %s | mlir-opt -allow-unregistered-dialect -verify-diagnostics | FileCheck %s
